...
class TSDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        return (inp, inp_n), (out, out_n), self.scaler, -1,  # wnd_start
...
class TSDataModule(pl.LightningDataModule):
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        if self.name == 'electricity':
            ...
            train_end = 10392
        elif self.name == "PeMSD8":
            self.start_date = "2016-7-1"
            train_end = int(17856 * 0.6)
            val_start = -int(17856 * 0.2)
        # N-HiTS Table 1
        elif self.name == "TrafficL":
        ...
        val_start -= self.cond_steps  # todo
        ...
        try:
            ...
            if self.name in ["traffic", "PeMSD8"]:
    ...
    def val_dataloader(self):
        ...
        val_ds = TSDataset(self.val_data, self.scaler, 
                           self.cond_steps, self.pred_steps, hbstep=1, 
